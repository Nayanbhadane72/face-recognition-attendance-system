...
class Admin_dashboard:
    def __init__(self, root, temp_user=""):
        ...
        # background
        bg_img = Label(self.root, bg="#59FBF4")
        bg_img.place(x=0, y=100, width=1280, height=640)

        title_lbl4 = Label(self.root, text="welcome, "+temp_user, font=(
            "time new roman", 18), bg="#59FBF4", fg="red")
        title_lbl4.place(x=-190, y=100, width=600, height=50)
        ...
        b4.place(x=550, y=150, width=180, height=180)
        b4_1 = Button(bg_img, command=self.train_data, text="Train Data", font=(
            "times new roman", 12, "bold"), bg="darkblue", fg="white")
        b4_1.place(x=550, y=320, width=180, height=40)
        ...
        b1 = Button(bg_img, image=self.tab_img12, command=self.Manage_users,
                    cursor="hand2")
        b1.place(x=850, y=150, width=180, height=180)
        b1_1 = Button(bg_img, text="Manage Users", font=(
            "times new roman", 12, "bold"), bg="darkblue", fg="white")
        b1_1.place(x=850, y=320, width=180, height=40)
