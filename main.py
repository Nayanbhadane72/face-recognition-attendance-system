...
class Dashboard:
    ...
    def __init__(self, root, tmp_user=""):
        ...
        title_lbl4 = Label(self.root, text="welcome, "+global_user, font=(
        ...
        b3.place(x=600, y=150, width=180, height=180)
        b3_1 = Button(bg_img, command=self.ManageAttendance, text="View Attendance", font=(
            "times new roman", 12, "bold"), bg="darkblue", fg="white")
        b3_1.place(x=600, y=320, width=180, height=40)
