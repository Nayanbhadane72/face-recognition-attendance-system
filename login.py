...
class Login:
    def __init__(self, root):
        ...
        self.root.wm_iconbitmap("App_logo.ico")
        ...
        back_btn = Button(self.root, command=self.backFunction, text="Exit", font=(
            "time new roman", 13, "bold"), width=16, bg="#D0492C", fg="white")
        ...
        loginbtn = Button(design_frame4, command=self.login, text="Login", font=("times new roman", 15, "bold"),
